   ...
   <div class="container ">
    <div class="row ">
     ...
     data-aos-offset="0">
       ...
       <!--<a class ="btn btn-primary mt-1 mx-5" ><button type="submit" name = "id" data-bs-toggle="modal" data-bs-target="#exampleModal" value="<?=$row['pId']?>"> รายละเอียด</button></a> -->
       ...
       <a class ="btn btn-primary  " name = "p_add" href="order.php?id=<?=$row['pId']?>">สั่งซื้อ</a>    
      </div>
