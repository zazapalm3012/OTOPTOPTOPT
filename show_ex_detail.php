   ...
   <a href="show_ex.php"><i class="fa-solid fa-left-long fa-2xl"></i></a>
    <div class="row g-2 ms-5">
      ...
      <div class="col-sm-2" style="color:white;">
        <img src="<?=$row['pImage']?>" width="200px" height="250px" class="mt-5 pt-2 my-2">
      ...
      <h3 class = "mt-4 pt-5 my-1 mx-5"style=color:#fc8eac;> <?=$row['pName']?><br> </h3>
      <h5 class ="my-1 mx-5 " style=color:#FFFF99;>  <?=$row['pDetail']?><br> </h5>
